...
const WebsiteMaintenance = () => {
  return (
    <>
      <Helmet>
        <title>Website Maintenance Services | WebDone</title>
        <meta
          name="description"
          content="Keep your website secure, updated, and performing at its best with WebDone's reliable website maintenance services."
        />
        <link rel="canonical" href="https://webdone.in/services/website-maintenance" />
      </Helmet>

      <section className="pt-16 pb-20 px-6 bg-gradient-to-r from-amber-400 to-amber-400 text-gray-900 min-h-screen">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          
          {/* Left Content */}
          <div className="flex-1">
            <h1 className="text-5xl font-extrabold font-serif leading-tight mb-4">
